...
export function Hero() {
  return (
    <section className="pt-24 bg-claw-green relative overflow-hidden">
      {/* Decorative shapes */}
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-display text-4xl md:text-6xl lg:text-7xl text-claw-black uppercase tracking-wide">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* Left Column - Text */}
          <div>
            <p className="text-claw-red font-mono text-sm mb-4">
              // Instalación y configuración de OpenClaw
            </p>
            <p className="text-lg text-claw-black/90 mb-6">
            ...
            <p className="text-lg text-claw-black/90 mb-8">
            ...
            <div className="flex items-center gap-6">
              <span className="text-sm text-claw-black/60 uppercase tracking-wide">
                Disponible en:
              </span>
