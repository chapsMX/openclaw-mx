      ...
      <div className="max-w-7xl mx-auto px-4 py-10 lg:py-12">
        ...
        <div className="text-center mb-10">
          <Image
            ...
            priority
          />
          <p className="text-claw-black/80 text-lg md:text-xl max-w-md mx-auto leading-relaxed">
            Tu asistente personal IA,<br />disponible 24/7.
          </p>
        </div>
        ...
        {/* Two Columns - Info + Terminal */}
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          {/* Left Column - Text */}
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-claw-black">
              Instalación y configuración de OpenClaw
            </h2>
            
            <div className="space-y-3 text-claw-black/85 leading-relaxed">
              <p>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 right-4 bg-claw-white border-3 border-claw-black px-4 py-2 z-10 shadow-[4px_4px_0px_#0a0a0a]">
              <span className="text-sm font-bold tracking-wide">OPEN SOURCE 🔥</span>
            </div>
